...
namespace mxnet.csharp
{
    ...
    {
        private static readonly string[] DllWhiteList = new[] { "cudnn64_6.dll", "libgcc_s_seh-1.dll", "libgfortran-3.dll", "libquadmath-0.dll", "libopenblas.dll", "libmxnet.dll" };

        static NativeMethods()
        {
            string dllPath = Environment.Is64BitProcess ? "x64" : "x86";

            var dlls = Directory.EnumerateFiles(dllPath).Select(Path.GetFileName).ToList();
        ...
        /// Return Type: char*
        [DllImport("libmxnet.dll", EntryPoint = "MXGetLastError", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// Return Type: int
        ///seed: int
        [DllImport("libmxnet.dll", EntryPoint = "MXRandomSeed", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXRandomSeed(int seed);


        /// Return Type: int
        [DllImport("libmxnet.dll", EntryPoint = "MXNotifyShutdown", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXNotifyShutdown();


        /// Return Type: int
        ///out: NDArrayHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayCreateNone", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///delay_alloc: int
        ///out: NDArrayHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayCreate", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///dtype: int
        ///out: NDArrayHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayCreateEx", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: NDArrayHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayLoadFromRawBytes", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: size_t*
        ///out_buf: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArraySaveRawBytes", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///args: NDArrayHandle*
        ///keys: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArraySave", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_names: char***
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayLoad", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///data: void*
        ///size: size_t->unsigned int
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArraySyncCopyFromCPU", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///data: void*
        ///size: size_t->unsigned int
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArraySyncCopyToCPU", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXNDArraySyncCopyToCPU(IntPtr handle, IntPtr data, uint size);


        /// Return Type: int
        ///handle: NDArrayHandle->void*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayWaitToRead", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXNDArrayWaitToRead(IntPtr handle);


        /// Return Type: int
        ///handle: NDArrayHandle->void*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayWaitToWrite", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXNDArrayWaitToWrite(IntPtr handle);


        /// Return Type: int
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayWaitAll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXNDArrayWaitAll();


        /// Return Type: int
        ///handle: NDArrayHandle->void*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: NDArrayHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArraySlice", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: NDArrayHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayAt", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_dim: mx_uint*
        ///out_pdata: mx_uint**
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayGetShape", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: NDArrayHandle->void*
        ///out_pdata: mx_float**
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayGetData", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: NDArrayHandle->void*
        ///out_dtype: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayGetDType", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_dev_type: int*
        ///out_dev_id: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXNDArrayGetContext", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXListFunctions", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///name: char*
        ///out: FunctionHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXGetFunction", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///return_type: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXFuncGetInfo", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///type_mask: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXFuncDescribe", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXFuncInvoke", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///param_keys: char**
        ///param_vals: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXFuncInvokeEx", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///name: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolGetAtomicSymbolName", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///vals: char**
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolCreateAtomicSymbol", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///name: char*
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolCreateVariable", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolCreateGroup", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///fname: char*
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolCreateFromFile", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///json: char*
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolCreateFromJSON", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///fname: char*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolSaveToFile", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbol: SymbolHandle->void*
        ///out_json: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolSaveToJSON", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXSymbolSaveToJSON(IntPtr symbol, out IntPtr outJson);


        /// Return Type: int
        ///symbol: SymbolHandle->void*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbol: SymbolHandle->void*
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolCopy", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbol: SymbolHandle->void*
        ///out_str: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolPrint", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: char**
        ///success: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolGetName", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: char**
        ///success: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolGetAttr", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///key: char*
        ///value: char*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolSetAttr", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: mx_uint*
        ///out: char***
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolListAttr", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: mx_uint*
        ///out: char***
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolListAttrShallow", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: mx_uint*
        ///out_str_array: char***
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolListArguments", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: mx_uint*
        ///out_str_array: char***
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolListOutputs", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbol: SymbolHandle->void*
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolGetInternals", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolGetOutput", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: mx_uint*
        ///out_str_array: char***
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolListAuxiliaryStates", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///keys: char**
        ///args: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolCompose", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///wrt: char**
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolGrad", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///complete: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolInferShape", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///aux_shape_data: mx_uint***
        ///complete: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolInferShapePartial", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///aux_type_data: int**
        ///complete: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXSymbolInferType", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXExecutorFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: ExecutorHandle->void*
        ///out_str: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXExecutorPrint", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: ExecutorHandle->void*
        ///is_train: int
        [DllImport("libmxnet.dll", EntryPoint = "MXExecutorForward", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXExecutorBackward", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: mx_uint*
        ///out: NDArrayHandle**
        [DllImport("libmxnet.dll", EntryPoint = "MXExecutorOutputs", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: ExecutorHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXExecutorBind", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///aux_states: NDArrayHandle*
        ///out: ExecutorHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXExecutorBindX", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: ExecutorHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXExecutorBindEX", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXExecutorSetMonitorCallback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXListDataIters", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///vals: char**
        ///out: DataIterHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXDataIterCreateIter", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///arg_type_infos: char***
        ///arg_descriptions: char***
        [DllImport("libmxnet.dll", EntryPoint = "MXDataIterGetIterInfo", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXDataIterFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: DataIterHandle->void*
        ///out: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXDataIterNext", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXDataIterNext(IntPtr handle, ref int @out);


        /// Return Type: int
        ///handle: DataIterHandle->void*
        [DllImport("libmxnet.dll", EntryPoint = "MXDataIterBeforeFirst", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: DataIterHandle->void*
        ///out: NDArrayHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXDataIterGetData", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_index: uint64_t**
        ///out_size: uint64_t*
        [DllImport("libmxnet.dll", EntryPoint = "MXDataIterGetIndex", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: DataIterHandle->void*
        ///pad: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXDataIterGetPadNum", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: DataIterHandle->void*
        ///out: NDArrayHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXDataIterGetLabel", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///keys: char**
        ///vals: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXInitPSEnv", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///type: char*
        ///out: KVStoreHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreCreate", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///keys: int*
        ///vals: NDArrayHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreInit", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// vals: NDArrayHandle*
        /// priority: int
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStorePush", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///vals: NDArrayHandle*
        ///priority: int
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStorePull", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///updater_handle: void*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreSetUpdater", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: KVStoreHandle->void*
        ///type: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreGetType", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: KVStoreHandle->void*
        ///ret: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreGetRank", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: KVStoreHandle->void*
        ///ret: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreGetGroupSize", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXKVStoreGetGroupSize(IntPtr handle, out int ret);


        /// Return Type: int
        ///ret: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreIsWorkerNode", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXKVStoreIsWorkerNode(out int ret);


        /// Return Type: int
        ///ret: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreIsServerNode", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXKVStoreIsServerNode(out int ret);


        /// Return Type: int
        ///ret: int*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreIsSchedulerNode", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXKVStoreIsSchedulerNode(out int ret);


        /// Return Type: int
        ///handle: KVStoreHandle->void*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreBarrier", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreSetBarrierBeforeExit", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///controller_handle: void*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreRunServer", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///cmd_id: int
        ///cmd_body: char*
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreSendCommmandToServers", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///number: int*
        ///timeout_sec: int
        [DllImport("libmxnet.dll", EntryPoint = "MXKVStoreGetNumDeadNode", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///uri: char*
        ///out: RecordIOHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXRecordIOWriterCreate", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXRecordIOWriterFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///buf: char*
        ///size: size_t->unsigned int
        [DllImport("libmxnet.dll", EntryPoint = "MXRecordIOWriterWriteRecord", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///handle: RecordIOHandle*
        ///pos: size_t*
        [DllImport("libmxnet.dll", EntryPoint = "MXRecordIOWriterTell", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///uri: char*
        ///out: RecordIOHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXRecordIOReaderCreate", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MXRecordIOReaderCreate([In()] [MarshalAs(UnmanagedType.LPStr)] string uri, ref IntPtr @out);


        /// Return Type: int
        ///handle: RecordIOHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXRecordIOReaderFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///buf: char**
        ///size: size_t*
        [DllImport("libmxnet.dll", EntryPoint = "MXRecordIOReaderReadRecord", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXRecordIOReaderSeek", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///kernel: char*
        ///out: RtcHandle*
        [DllImport("libmxnet.dll", EntryPoint = "MXRtcCreate", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "MXRtcPush", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// Return Type: int
        ///handle: RtcHandle->void*
        [DllImport("libmxnet.dll", EntryPoint = "MXRtcFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// param_keys: char**
        /// param_vals: char**
        [DllImport("libmxnet.dll", EntryPoint = "MXImperativeInvoke", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// Return Type: void
        ///msg: char*
        [DllImport("libmxnet.dll", EntryPoint = "NNAPISetLastError", CallingConvention = CallingConvention.Cdecl)]
        public static extern void NNAPISetLastError([In()] [MarshalAs(UnmanagedType.LPStr)] string msg);


        /// Return Type: char*
        [DllImport("libmxnet.dll", EntryPoint = "NNGetLastError", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: nn_uint*
        ///out_array: char***
        [DllImport("libmxnet.dll", EntryPoint = "NNListAllOpNames", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///op_name: char*
        ///op_out: OpHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNGetOpHandle", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: nn_uint*
        ///out_array: OpHandle**
        [DllImport("libmxnet.dll", EntryPoint = "NNListUniqueOps", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///arg_descriptions: char***
        ///return_type: char**
        [DllImport("libmxnet.dll", EntryPoint = "NNGetOpInfo", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///vals: char**
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolCreateAtomicSymbol", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///name: char*
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolCreateVariable", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbols: SymbolHandle*
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolCreateGroup", CallingConvention = CallingConvention.Cdecl)]
        public static extern int NNSymbolCreateGroup(uint num_symbols, ref IntPtr symbols, ref IntPtr @out);


        /// Return Type: int
        ///symbol: SymbolHandle->void*
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbol: SymbolHandle->void*
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolCopy", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbol: SymbolHandle->void*
        ///out_str: char**
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolPrint", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: char**
        ///success: int*
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolGetAttr", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///keys: char**
        ///values: char**
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolSetAttrs", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: nn_uint*
        ///out: char***
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolListAttrs", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: nn_uint*
        ///out_str_array: char***
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolListInputNames", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out_size: nn_uint*
        ///out_str_array: char***
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolListOutputNames", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbol: SymbolHandle->void*
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolGetInternals", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///out: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolGetOutput", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///keys: char**
        ///args: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNSymbolCompose", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbol: SymbolHandle->void*
        ///graph: GraphHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNGraphCreate", CallingConvention = CallingConvention.Cdecl)]
        public static extern int NNGraphCreate(IntPtr symbol, ref IntPtr graph);


        /// Return Type: int
        ///handle: GraphHandle->void*
        [DllImport("libmxnet.dll", EntryPoint = "NNGraphFree", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///symbol: SymbolHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNGraphGetSymbol", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///key: char*
        ///json_value: char*
        [DllImport("libmxnet.dll", EntryPoint = "NNGraphSetJSONAttr", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///json_out: char**
        ///success: int*
        [DllImport("libmxnet.dll", EntryPoint = "NNGraphGetJSONAttr", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libmxnet.dll", EntryPoint = "NNGraphSetNodeEntryListAttr_", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///pass_names: char**
        ///dst: GraphHandle*
        [DllImport("libmxnet.dll", EntryPoint = "NNGraphApplyPasses", CallingConvention = CallingConvention.Cdecl)]
