...
namespace UnitTestProject
{
    ...
    public class NArrayUnitTest
    {
        ...
        public void TestSlice1()
        {
            ...
            CollectionAssert.AreEqual(test4_np_result, test4_result.Flat().data, "3");
            ...
            CollectionAssert.AreEqual(test5_np_result, test5_result.Flat().data, "3");
        }
        ...
        public void TestSlice2()
        {
            ...
            List<float> test1_np_result = eval_array<float>("arr[1:5:2,10::-1]", new Parameter<float>("arr", testshape, test));
            var test1_result = testsingle["1:5:2", "10::-1"];
            CollectionAssert.AreEqual(test1_np_result, test1_result.Flat().data, "1");
